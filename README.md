...
## Heroku
- Click [![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Minoritasia/ravager) and fill the environment variables accordingly. 
